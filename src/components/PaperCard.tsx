...
export function PaperCard({ children, className = '', decoration = 'none', torn = 'none' }: PaperCardProps) {
  return (
    <div className={`relative ${className}`} style={{ overflow: "visible" }}>
      ...
      {/* Torn edge top */}
      {(torn === 'top' || torn === 'both') && (
        <div className="absolute -top-[8px] left-0 right-0 h-[8px]" style={{ overflow: "visible" }}>
      ...
      <div
        ...
        style={{
          ...
          paddingTop: torn === 'top' || torn === 'both' ? '12px' : undefined,
          paddingBottom: torn === 'bottom' || torn === 'both' ? '12px' : undefined,
          backgroundImage: `
      ...
      {(torn === 'bottom' || torn === 'both') && (
        <div className="absolute -bottom-[8px] left-0 right-0 h-[8px]" style={{ overflow: "visible" }}>
          <svg width="100%" height="8" preserveAspectRatio="none" viewBox="0 0 400 8">
            <path
      ...
      {decoration === 'tape' && (
        <>
          <div 
            ...
            style={{ boxShadow: 'inset 0 1px 2px rgba(0,0,0,0.1)', overflow: "visible" }}
          />
          <div 
      ...
      {decoration === 'staple' && (
        <>
          <div className="absolute top-2 left-4" style={{ overflow: "visible" }}>
            <svg width="20" height="8" viewBox="0 0 20 8">
              <path d="M2,0 L2,6 M2,6 L18,6 M18,6 L18,0"
                stroke="#4A4A4A" strokeWidth="1.5" fill="none" />
            </svg>
          </div>
          <div className="absolute top-2 right-4" style={{ overflow: "visible" }}>
            <svg width="20" height="8" viewBox="0 0 20 8">
              <path d="M2,0 L2,6 M2,6 L18,6 M18,6 L18,0"
                stroke="#4A4A4A" strokeWidth="1.5" fill="none" />
            </svg>
      ...
      {decoration === 'clip' && (
        <div className="absolute -top-4 left-1/2 -translate-x-1/2" style={{ overflow: "visible" }}>
